...
{
    public class ExperimentClass_01
    {
        IRepositoryFactory repositoryFactory;
        public ExperimentClass_01(IRepositoryFactory repositoryFactory) { this.repositoryFactory = repositoryFactory; }
        public void Run() 
        { 
